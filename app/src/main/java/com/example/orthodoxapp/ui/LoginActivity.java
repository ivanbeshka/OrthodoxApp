...
public class LoginActivity extends BaseActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
      ...
      firebaseAuth.signInWithEmailAndPassword(email, password)
          .addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
              ...
              Toast.makeText(getApplicationContext(), R.string.email_or_pass_not_right,
    ...
    btnCreateAcc.setOnClickListener(
        v -> startActivity(new Intent(getApplicationContext(), RegistrationActivity.class)));
  }
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (requestCode == RC_SIGN_IN) {
      ...
      try {
        ...
        Snackbar.make(findViewById(R.id.login_layout), R.string.auth_fail, Snackbar.LENGTH_SHORT)
            .show();
      }
    }
    ...
    firebaseAuth.signInWithCredential(credential)
        .addOnCompleteListener(this, task -> {
          if (task.isSuccessful()) {
            ...
            Snackbar
                .make(findViewById(R.id.login_layout), R.string.auth_fail, Snackbar.LENGTH_SHORT)
                .show();
          }
